...
@section('content')
	...
	<div class = "panel">
		<div class = "panel-body">
			<form id = "form_post" role = "form" method = "POST" action = "{{ action('Admin\PostController@store') }}">
	...
	<div class = "panel panel-post">
		<div class = "panel-body">
			...
			<br>
			<div class = "row">
				<form class = "form_comment" role = "form" method = "POST" action = "{{ action('Admin\CommentController@store') }}">
					<div class = "col-sm-12">
